...
public class ActivityTest {
    ...
    static  void init() {
        ...
        activityTest.actvity = new Actvity(title, type, description,lat,lng);
    }
    ...
    void testConstructor(){
        ActivityTest activityTest = new ActivityTest();
        Actvity act = activityTest.actvity ;
        Assert.assertArrayEquals("Check the Constructor",
            new Object[]{"Runner", "Jogging", "The best runners location in goteborg", 55.0, 14.0},
            new Object[]{act.getTitle(),act.getType(),act.getDescription(),act.getLat(),act.getLng()});
    }
    ...
    void SetValues() {
        ActivityTest activityTest = new ActivityTest();
        Actvity actvity = activityTest.actvity;
